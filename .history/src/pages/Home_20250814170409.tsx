...
//types
import { HighligthsData } from "@/types";
// Utils
                ...
                <CardComponent className={highlightsData ? highlightsData[1].subtitle : 'skeleton-loading skeleton-loading-mh-1'}>
                  {!highlightsLoading && highlightsData && (
                    <>
                      ...
                      <StyledH3>{currencyConverter(highlightsData[1].value)}</StyledH3>
                      <StyledSpan>{highlightsData[1].subtitle}</StyledSpan>
                    </>
                  )}
                </CardComponent>
              </Grid>
                ...
                <CardComponent className={highlightsLoading ? 'skeleton-loading skeleton-loading-mh-1' : ''}>
                  {!highlightsLoading && highlightsData && (
                    <>
                      ...
                      <StyledH3>{currencyConverter(highlightsData[2].value)}</StyledH3>
