                ...
                >
                  {!highlightsLoading && highlightsData && (
                    <>
                      ...
                      <StyledH3 className="mb-1" color='white' size={40} lineHeight={40}>{currencyConverter(highlightsData[0].value)} </StyledH3>
                      <StyledSpan color='white'>{highlightTextConverter(highlightsData[0].subtitle)}</StyledSpan>
                    </>
                  )}
