  ...
  const getData = async () => {
    ...
    try {
      const response = await axioInstance({
        ...
        method: '',
        headers: {
          'Authorization': `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjQ1NiwiaWF0IjoxNzU1NTM4NTA3LCJleHAiOjE3NTU1NDU3MDd9.h2OcjUT7ckEht0i4PqI5uDFljkQ633bOZ-DHqRbnDxk` , 
          ...config?.headers,
        },
        ...config,
      })
